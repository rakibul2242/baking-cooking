<div class="container mx-auto px-4 grid md:grid-cols-3 gap-6 w-3/4">
    <div class="flex flex-col space-y-3 p-6 rounded-lg shadow bg-white">
        ...
        <div>
            <div class="flex space-x-2">
                ...
                <div>
                    ...
                    <div class="text-xs text-gray-500">Professional Baker</div>
                </div>
            </div>
        </div>
    </div>
    <div class="flex flex-col space-y-3 p-6 rounded-lg shadow bg-white">
        ...
        <div>
            <div class="flex space-x-2">
                ...
                <div>
                    <div class="text-orange-950 text-sm font-bold">Student Name</div>
                    <div class="text-xs text-gray-500">Pastry Chef</div>
                </div>
            </div>
        </div>
    </div>
